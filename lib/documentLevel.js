...
exports.ccd2 = function (html_renderer) {
    var ccd_template = {
        ...
        fieldLevel.templateId("2.16.840.1.113883.10.20.22.1.1", "2015-08-01"),
        fieldLevel.templateId("2.16.840.1.113883.10.20.22.1.1"),
        fieldLevel.templateId("2.16.840.1.113883.10.20.22.1.2", "2015-08-01"),
        fieldLevel.templateId("2.16.840.1.113883.10.20.22.1.2"), [fieldLevel.id, dataKey("meta.identifiers")], {
            key: "code",
            attributes: {
                codeSystem: "2.16.840.1.113883.6.1",
        ...
        headerLevel.providers, {
            ...
            content: {
                ...
                content: [
                    ...
                    [sectionLevel2.immunizationsSectionEntriesOptional(html_renderer.immunizationsSectionEntriesOptionalHtmlHeader, html_renderer.immunizationsSectionEntriesOptionalHtmlHeaderNA), required],
                    ...
                    sectionLevel2.healthcareConcernsSection(html_renderer.healthcareConcernsSectionHtmlHeader, html_renderer.healthcareConcernsSectionHtmlHeaderNA),
