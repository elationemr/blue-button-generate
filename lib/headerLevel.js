...
var patient = exports.patient = {
    ...
    content: [
        patientName, {
            ...
            attributes: {
                code: translate.singleLetterCode,
...
var headerInformant = exports.headerInformant = {
    ...
    content: {
        ...
        fieldLevel.usRealmAddress,
        {
            ...
            dataKey: "informant.assigned_person"
        }, {
            key: "representedOrganization",
            content: [{
                key: "id",
...
var providers = exports.providers = {
    ...
    content: {
        ...
        content: [
            [fieldLevel.effectiveTime, dataKey("providers.date_time")],
            [provider, dataKey("providers.providers")]
        ],
    },
    dataKey: "data.header"
};
