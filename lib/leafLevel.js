...
exports.nextHtmlReference = function (referenceKey) {
    return function (input, context) {
        return context.nextHtmlReference(referenceKey);
    }
}
...
exports.sameHtmlReference = function (referenceKey) {
    return function (input, context) {
        return context.sameHtmlReference(referenceKey);
    }
}
