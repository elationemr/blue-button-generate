...
var getText = function (topArrayKey, headers, values, headerToReferenceKey) {
    var result = {
        key: "text",
    ...
    values.forEach(function (value, idx) {
        ...
        if (headerToReferenceKey[header]) {
            element.attributes = {
                "ID": leafLevel.nextHtmlReference(headerToReferenceKey[header])
            }
        }
...
var allergiesTextHeaders = ["Substance", "Overall Severity", "Reaction", "Reaction Severity", "Status"];
var allergyHeaderToReferenceKey = {
    "Substance": "allergen",
    "Reaction": "reaction",
...
exports.allergiesSectionEntriesRequiredHtmlHeader = getText('allergies', allergiesTextHeaders, allergiesTextRow, allergyHeaderToReferenceKey);

var medicationsTextHeaders = ["Medication Class", "# fills", "Instructions", "Last fill date"];
var medicationHeaderToReferenceKey = {
    "Medication Class": "medinfo",
...
var medicationsTextRow = [ // Name, did not find class in the medication blue-button-data
    ...
    leafLevel.deepInputProperty("sig"),
    leafLevel.deepInputDate("supply.date_time.point", "")
];

exports.medicationsSectionEntriesRequiredHtmlHeader = getText('medications', medicationsTextHeaders, medicationsTextRow, medicationHeaderToReferenceKey);
        ...
        content: [{
            ...
            content: [{
                ...
                content: [{
                    key: "td",
                    attributes: {
                        "ID": leafLevel.nextHtmlReference("problem")
                    },
        ...
        content: [{
            ...
            content: [{
                ...
                content: [{
                    key: "td",
                    attributes: {
                        "ID": leafLevel.nextHtmlReference("procedure")
                    },
        ...
        content: [{
            ...
            content: [{
                ...
                content: [{
                    ...
                    key: "td",
                    attributes: {
                        "ID": leafLevel.nextHtmlReference("result")
                    },
        ...
        content: [{
            ...
            content: [{
                ...
                content: [{
                    ...
                    key: "td",
                    attributes: {
                        "ID": leafLevel.nextHtmlReference("Encounter")
                    },
...
var immunizationTextHeaders = ["Vaccine", "Date", "Status"];
var immunizationTextRows = [
    leafLevel.deepInputProperty("product.product.name", ""),
    leafLevel.deepInputDate("date_time.point", ""),
    leafLevel.deepInputProperty("status", "")
]
var immunizationHeaderToReferenceKey = {
    "Vaccine": "immunization"
}

exports.immunizationsSectionEntriesOptionalHtmlHeader = getText("immunizations", immunizationTextHeaders, immunizationTextRows, immunizationHeaderToReferenceKey);
        ...
        content: [{
            ...
            content: [{
                ...
                content: [{
                    ...
                    key: "td",
                    text: leafLevel.deepInputProperty("assessment", nda)
                }]
            }],
            dataKey: 'assessments'
        }],
...
exports.healthcareConcernsSectionHtmlHeader = {
    key: "text",
    existsWhen: condition.keyExists("health_concerns"),
    content: [{
        // key: "paragraph",
        // content: [{
        //     key: "list",
            ...
            content: [{
                ...
                content: [{
                    ...
                    content: [{
                        ...
                        content: [{
                            key: "item",
                            // text: leafLevel.inputProperty("concern"),
                            content: [{
                                key: "list",
                                attributes: {
                                    listType: "ordered"
                                ...
                                content: [{
                                    key: "item",
                                    text: leafLevel.inputProperty("note")
                                }],
                                dataKey: "notes"
                            }]
                        }]
        ...
        content: [{
            ...
            content: [{
                ...
                content: [{
                    ...
                    text: leafLevel.input,
                    dataTransform: function () {
                        return ["Social History Observation", "Description", "Effective Time"];
                    }
                }]
            }]
        }, {
            ...
            content: [{
                ...
                content: [{
                    key: "td",
                    text: leafLevel.deepInputProperty("observation", nda)
                }, {
                    key: "td",
                    text: leafLevel.deepInputProperty("value", nda)
                }, {
        ...
        content: [{
            ...
            content: [{
                ...
                content: [{
                    ...
                    key: "td",
                    attributes: {
                        "ID": leafLevel.nextHtmlReference("vital")
                    },
                    text: leafLevel.deepInputProperty("vital.name", nda)
                }, {
                    key: "td",
                    text: leafLevel.deepInputProperty("value", nda)
                }, {
                    key: "td",
                    text: leafLevel.deepInputProperty("unit", "")
                }]
            }],
            dataKey: 'vitals.vitals'
        }]
    }]
};
...
exports.healthcareConcernsSectionHtmlHeaderNA = "Not Available";
