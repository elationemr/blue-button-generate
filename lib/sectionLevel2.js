...
exports.allergiesSectionEntriesRequired = function (htmlHeader, na) {
    return {
        ...
        content: [{
            key: "section",
            content: [
                fieldLevel.templateId("2.16.840.1.113883.10.20.22.2.6.1", "2015-08-01"),
...
exports.medicationsSectionEntriesRequired = function (htmlHeader, na) {
    return {
        ...
        content: [{
            key: "section",
            content: [
                fieldLevel.templateId("2.16.840.1.113883.10.20.22.2.1.1", "2014-06-09"),
...
exports.problemsSectionEntriesRequired = function (htmlHeader, na) {
    return {
        ...
        content: [{
            key: "section",
            content: [
                fieldLevel.templateId("2.16.840.1.113883.10.20.22.2.5.1", "2015-08-01"),
    ...
    return {
        ...
        content: [{
            ...
            content: [
                ...
                fieldLevel.templateId("2.16.840.1.113883.10.20.22.2.3.1", "2015-08-01"),
...
exports.encountersSectionEntriesOptional = function (htmlHeader, na) {
    return {
        ...
        content: [{
            key: "section",
            content: [
                fieldLevel.templateId("2.16.840.1.113883.10.20.22.2.22.1", "2015-08-01"),
...
exports.healthcareConcernsSection = function (htmlHeader, na) {
    return {
        key: "component",
        content: [{
            key: "section",
            content: [
                ...
                //     key: "entry",
                //     content: [
                //         entryLevel.healthcareConcernEntry
                //     ],
...
exports.socialHistorySection = function (htmlHeader, na) {
    return {
        ...
        content: [{
            key: "section",
            content: [
                fieldLevel.templateId("2.16.840.1.113883.10.20.22.2.17", "2015-08-01"),
    ...
    return {
        ...
        content: [{
            ...
            content: [
                ...
                fieldLevel.templateId("2.16.840.1.113883.10.20.22.2.4.1", "2015-08-01"),
